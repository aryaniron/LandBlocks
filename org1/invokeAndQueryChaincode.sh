...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        -c '{"function": "AddLand","Args":["land-35", "111", "234", "fhuioyh7u34yt78yhfht", "Commercial", "No", "sfgvohng,ggduoighd,erg", "180001", "Chakroi", "RS Pura", "Jammu", "Jammu", "J&K","1/2/4", "12.354,67.982323,29.00121,34.56767,30.9001,23.45674" ]}'
        ...
        # --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        # --peerAddresses localhost:11051 --tlsRootCertFiles $PEER0_ORG3_CA \
        # -c '{"function": "ForSale","Args":["land-35","true","24324343243"]}'
...
chaincodeQuery() {
    ...
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "QueryLandById","Args":["land-36"]}'
