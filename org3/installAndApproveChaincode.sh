...
presetup() {
    echo Vendoring Go dependencies ... $chaincode_name $chaincode_version
    pushd ./../chaincodes/$chaincode_name/go
...
approveForMyOrg3() {
    ...
    peer lifecycle chaincode approveformyorg -o 35.202.97.126:7050 \
